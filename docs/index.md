...
Готовые документы по результатам проверок: [HTML/PDF-отчеты по комплексным методам](reports.md).
...
- [opensanctions](fiz/27-opensanctions.md) — санкционный и PEP-скрининг физлиц и организаций с точным уточнением по ИНН и дате рождения
...
- [Комплексный отчет](foreign/09-complex-report.md) — объединение миграционных проверок в HTML/PDF
...
- [fns_bo](legal/09-fns_bo.md) — бухгалтерская (финансовая) отчетность организации (ГИР БО / ФНС)
